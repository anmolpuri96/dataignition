...
def main():
    ...
    xml_files = ["s3a://dataignition-tech-xml/" + post_xml for post_xml in posts_xml]
    ...
    #     "iid")
    posts_udf.write.parquet("s3a://dataignition-tech-xml-parq/posts-new.parquet")
